...
class CoreException extends \RuntimeException implements ExceptionInterface
{

	public static function notActived(string $item)
	{
		return new static(lang('Core.notActived', [$item]));
	}
	
	public static function LanguageNotExist()
	{
		return new static(lang('Core.LanguageNotExist'));
	}
